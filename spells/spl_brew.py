...
def spl_brew(sn, level, ch, victim, target):
    ...
    if not arg1 or not arg2:
        ch.send("What spell do you wish to brew, and on what?\n")
        return
