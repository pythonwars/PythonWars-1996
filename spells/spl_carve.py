...
def spl_carve(sn, level, ch, victim, target):
    ...
    if not arg1 or not arg2:
        ch.send("What spell do you wish to carve, and on what?\n")
        return
    ...
    handler_game.act("$n carves $p.", ch, item, None, merc.TO_ROOM)
